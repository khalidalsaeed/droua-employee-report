...
/* Follow-up threshold for the "situation NOW" figures, matching SOON in
   doc-status.js — the platform has one operational follow-up window and the
   report must not state a different one than the dashboard does. It read 60
   here while the dashboard read 90, and the comment claimed they matched.

   The 30/60/90 bands in upcomingDues() below are deliberately NOT this number:
   those answer "what is coming up over the next quarter" for planning, not
