...
function buildDocDefinition(d) {
  ...
  /* ── renewals ── */
  const renewCols = ["رقم ضمان", "اسم الموظف", "رقم الإقامة", "الانتهاء السابق", "الانتهاء الجديد", "تاريخ التسجيل"];
  ...
  if (d.permitRenewals.length) {
    content.push(table(
      ["رقم ضمان", "اسم الموظف", "رقم الإقامة", "التصريح السابق", "التصريح الجديد", "الانتهاء السابق", "الانتهاء الجديد", "تاريخ التسجيل"],
  ...
  if (d.upcoming.length) {
    content.push(table(
      ["رقم ضمان", "اسم الموظف", "رقم الإقامة", "نوع المستند", "تاريخ الانتهاء", "المتبقي", "الفئة"],
