...
const PROOF_COLS = `p.employee_eid, p.employee_name, p.job_title, p.file_url, p.file_name, to_char(p.uploaded_at AT TIME ZONE 'Asia/Riyadh','YYYY-MM-DD') as uploaded_at, p.uploaded_by, e.data->>'رقم جسر' AS jisr_no`;
