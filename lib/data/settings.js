...
/* Read is open to any signed-in user — matches the pre-migration behaviour
   where financial totals were embedded in app-shell.html for any
   authenticated role. Only Owner/Admin can change settings. */
const auth = { read: () => true, write: isAdminLike };
...
module.exports = { list, get, set, auth };
