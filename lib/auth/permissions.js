...
const SECTIONS = [
  ...
  { key: "employees", label: "سجل الموظفين", actions: ["view", "create", "edit", "delete"] },
...
const ROLE_DEFAULT_SPECS = {
  owner: "*",
  admin: "*",
  hr: { kpi: ["view"], employees: ["view"], ajeer: ["view"], contact: ["view"], settings: ["view"] },
  finance: { finance: ["view"], payroll: ["view"], settings: ["view"] },
  viewer: { kpi: ["view"], finance: ["view"], employees: ["view"], ajeer: ["view"], contact: ["view"], settings: ["view"] },
};
