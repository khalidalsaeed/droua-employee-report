...
const PARSERS = {
  csv,
  /* Excel بصيغتيه: قارئان مكتوبان بلا اعتماد خارجيّ — ZIP+XML للحديثة،
     وحاوية OLE2 وسجلّات BIFF8 للقديمة. وكلاهما ينتهي إلى المطبِّع نفسه
     في csv.js، فلا يُكتب منطق أسماء الأعمدة مرّتين. */
  xlsx,
  xls,
  /* PDF: العقد المطلوب من قارئه — استخراج نصّ الجدول بترتيب الأعمدة، ثمّ
     تمريره إلى المطبِّع نفسه. والمشروع يحمل pdfjs-dist أصلًا لمسير أجير،
     فلا اعتماد جديد يوم يُكتب. */
  pdf: skeleton("pdf"),
};
