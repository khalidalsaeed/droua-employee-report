...
/* أسماء الحقول كما تصل من المصدر (بعضها يحمل مسافة زائدة في آخره).
   ...
   للموظف رقمان في نظامين مستقلّين، ولا يُستبدل أحدهما بالآخر:
     damanah — رقمه لدى شركة ضمان (500، 501 …). هو معرّف الموظف في هذه
               المنصّة: عمود employees.eid ومفتاح الربط في التذاكر
               والتصاريح وإثباتات التحويل.
     jisr    — رقمه في نظام جسر الذي يُخرج كشوف الرواتب (49، 55 …).

   المفتاح المخزَّن لرقم ضمان يبقى "الرقم الوظيفي" حرفيًا — تسمية عامّة
   من أيام نظام واحد. تغييره يعني هجرة JSONB في كل صفّ وتغيير مفتاح ربط
   عبر أربعة جداول، بمكسب صفر: لا أحد يرى مفتاح التخزين. فالتوضيح يقع
   في الاسم البرمجي وفي كل ما يُعرض للمستخدم، لا في التخزين. */
const F = {
  damanah:"الرقم الوظيفي", name:"اسم العامل", iqama:"رقم الإقامة", nat:"الجنسية", job:"المهنة",
  ...
  /* رقم الموظف في نظام جسر الذي يُخرج كشوف الرواتب. ترقيم مستقلّ عن
     «الرقم الوظيفي» تمامًا، وهو مفتاح الربط الوحيد بين الكشف والسجلّ. */
  jisr:"رقم جسر",
